...
def validate_phone():
    ...
    #         return render_template('validate_phone.html', phone_number=phone_number, isnt_valid=True, error_msg=types_of_error[0])
    ...
    # return render_template('validate_phone.html', phone_number=phone_number, isnt_valid=isnt_valid, error_msg=error_msg)
